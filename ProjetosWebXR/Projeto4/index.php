...
if($_SESSION['cargo'] == "professores" || $_SESSION['cargo'] == "autodidatas"){     
  ...
  if ($sql_query_video->num_rows == 0){
    $insert = "INSERT INTO desempenho (ID, Video4) VALUES ('$id', 1)";
    $conn->query($insert);
  } else{
    $update = "UPDATE desempenho SET Video4 = 1 WHERE ID = '$id'";
    $conn->query($update);
  }
...
<html lang="en-us">
  ...
  <body>
    ...
    <script>
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Projeto4.loader.js";
      var config = {
        dataUrl: buildUrl + "/Projeto4.data",
        frameworkUrl: buildUrl + "/Projeto4.framework.js",
        codeUrl: buildUrl + "/Projeto4.wasm",
