...
if($_SESSION['cargo'] == "professores" || $_SESSION['cargo'] == "autodidatas"){     
  ...
  if ($sql_query_video->num_rows == 0){
    $insert = "INSERT INTO desempenho (ID, Video7) VALUES ('$id', 1)";
    $conn->query($insert);
  } else{
    $update = "UPDATE desempenho SET Video7 = 1 WHERE ID = '$id'";
    $conn->query($update);
  }
...
<html lang="en-us">
  ...
  <body>
    ...
    <script>
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Projeto7.loader.js";
      var config = {
        dataUrl: buildUrl + "/Projeto7.data",
        frameworkUrl: buildUrl + "/Projeto7.framework.js",
        codeUrl: buildUrl + "/Projeto7.wasm",
