...
if($_SESSION['cargo'] == "professores" || $_SESSION['cargo'] == "autodidatas"){     
  ...
  if ($sql_query_video->num_rows == 0){
    $insert = "INSERT INTO desempenho (ID, Video2) VALUES ('$id', 1)";
    $conn->query($insert);
  } else{
    $update = "UPDATE desempenho SET Video2 = 1 WHERE ID = '$id'";
    $conn->query($update);
  }
...
<html lang="en-us">
  ...
  <body>
    ...
    <script>
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Projeto2.loader.js";
      var config = {
        dataUrl: buildUrl + "/Projeto2.data",
        frameworkUrl: buildUrl + "/Projeto2.framework.js",
        codeUrl: buildUrl + "/Projeto2.wasm",
